...
class SplPlugin(SplThread):
	...
	def __init__(self, modref):
		...
		self.movielist_storage = JsonStorage(
			self.plugin_id, 'runtime', "myplugin.json", {'movielist': {}}) # set defaults
	...
	def query_handler(self, queue_event, max_result_count):
		# print("myplugin handler query handler", queue_event.type,  queue_event.user, max_result_count)
